                                ...
                                child: Column(
                                  ...
                                  children: <Widget> [
                                    ...
                                    DetailRow(
                                      ...
                                      amount: double.parse(barbecuedPork[1]) *_servings,
                                    ...
                                    DetailRow(
                                      ...
                                      amount: double.parse(barbecuedPork[7]) * _servings,
                                      unit: barbecuedPork[8],
                                    ),
                                    DetailRow(
                                      name: barbecuedPork[9],
                                      amount: double.parse(barbecuedPork[10]) * _servings,
                                      unit: barbecuedPork[11],
                                    ),
                                    DetailRow(
                                      name: barbecuedPork[12],
                                      amount: double.parse(barbecuedPork[13]) * _servings,
                                      unit: barbecuedPork[14],
                                    ),
                                    DetailRow(
                                      name: barbecuedPork[15],
                                      amount: double.parse(barbecuedPork[16]) * _servings,
                                      unit: barbecuedPork[17],
                                    ),
                                    DetailRow(
                                      name: barbecuedPork[18],
                                      amount: double.parse(barbecuedPork[19]) * _servings,
                                      unit: barbecuedPork[20],
                                    ),
                                    DetailRow(
                                      name: barbecuedPork[21],
                                      amount: double.parse(barbecuedPork[22]) * _servings,
                                      unit: barbecuedPork[23],
                                    ),
                                    DetailRow(
                                      name: barbecuedPork[24],
                                      amount: double.parse(barbecuedPork[25]) * _servings,
                                      unit: barbecuedPork[26],
                                    ),
                                    DetailRow(
                                      name: barbecuedPork[27],
                                      amount: double.parse(barbecuedPork[28]) * _servings,
                                    ...
                                    DetailRow(
                                      ...
                                      amount: double.parse(porkBoneBroth[1]) * _servings,
                                      unit: porkBoneBroth[2],
                                    ),
                                    DetailRow(
                                      name: porkBoneBroth[3],
                                      amount: double.parse(porkBoneBroth[4]) * _servings,
                                      unit: porkBoneBroth[5],
                                    ),
                                    DetailRow(
                                      name: porkBoneBroth[6],
                                      amount: double.parse(porkBoneBroth[7]) * _servings,
                                      unit: porkBoneBroth[8],
                                    ),
                                    DetailRow(
                                      name: porkBoneBroth[9],
                                      amount: double.parse(porkBoneBroth[10]) * _servings,
                                      unit: porkBoneBroth[11],
                                    ),
                                    DetailRow(
                                      name: porkBoneBroth[12],
                                      amount: double.parse(porkBoneBroth[13]) * _servings,
                                    ...
                                    DetailRow(
                                      ...
                                      amount: double.parse(japaneseRamen[1]) * _servings,
                                      unit: japaneseRamen[2],
                                    ),
                                    DetailRow(
                                      name: japaneseRamen[3],
                                      amount: double.parse(japaneseRamen[4]) * _servings,
                                      unit: japaneseRamen[5],
                                    ),
                                    DetailRow(
                                      name: japaneseRamen[6],
                                      amount: double.parse(japaneseRamen[7]) * _servings,
