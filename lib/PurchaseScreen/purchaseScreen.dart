...
class _PurchaseScreenState extends State<PurchaseScreen> {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        primary: totalPrice() != "0.0" ? Colors.pink : Colors.blueGrey[200],
                      ...
                      onPressed: totalPrice() != "0.0" ? () {
                        // Debug message
                        print("[INFO] Confirm button is pressed!");
  ...
  void addItem(int i) {
    // Debug message
    print("[INFO] Add item $i button is pressed!");
  ...
  void subItem(int i) {
    // Debug message
    print("[INFO] Subtract item $i button is pressed!");
